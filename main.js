...
import {ArrinArr, getObstacleMaps, getMouseCoords, popValue} from './globalFunctions.js';
...
const columns = 10;
let cellSize = 1;
canvasContainer.clientHeight < canvasContainer.clientWidth ? cellSize = canvasContainer.clientHeight / rows : cellSize = canvasContainer.clientWidth / rows;
